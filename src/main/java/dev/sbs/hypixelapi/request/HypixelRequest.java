...
import dev.sbs.minecraftapi.client.hypixel.response.hypixel.guild.HypixelGuildResponse;
import dev.sbs.minecraftapi.client.hypixel.response.hypixel.player.HypixelPlayerResponse;
...
import dev.sbs.minecraftapi.client.hypixel.response.skyblock.auction.SkyBlockAuctionResponse;
import dev.sbs.minecraftapi.client.hypixel.response.skyblock.auction.SkyBlockAuctionsEndedResponse;
import dev.sbs.minecraftapi.client.hypixel.response.skyblock.auction.SkyBlockAuctionsResponse;
import dev.sbs.minecraftapi.client.hypixel.response.skyblock.bazaar.SkyBlockBazaarResponse;
import dev.sbs.minecraftapi.client.hypixel.response.skyblock.firesales.SkyBlockFireSaleResponse;
import dev.sbs.minecraftapi.client.hypixel.response.skyblock.island.SkyBlockProfilesResponse;
import dev.sbs.minecraftapi.client.hypixel.response.skyblock.museum.SkyBlockMuseumResponse;
import dev.sbs.minecraftapi.client.hypixel.response.skyblock.news.SkyBlockNewsResponse;
import feign.Param;
