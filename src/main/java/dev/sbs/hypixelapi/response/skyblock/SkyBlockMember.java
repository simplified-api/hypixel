...
import dev.sbs.hypixelapi.response.skyblock.member.*;
import dev.sbs.hypixelapi.response.skyblock.member.attribute.AttributeShards;
import dev.sbs.hypixelapi.response.skyblock.member.crimson.CrimsonIsle;
import dev.sbs.hypixelapi.response.skyblock.member.crimson.TrophyFishing;
import dev.sbs.hypixelapi.response.skyblock.member.dungeon.Dungeons;
import dev.sbs.hypixelapi.response.skyblock.member.foraging.Foraging;
import dev.sbs.hypixelapi.response.skyblock.member.foraging.HeartOfTheForest;
import dev.sbs.hypixelapi.response.skyblock.member.foraging.Temples;
import dev.sbs.hypixelapi.response.skyblock.member.hoppity.ChocolateFactory;
import dev.sbs.hypixelapi.response.skyblock.member.mining.ForgeItem;
import dev.sbs.hypixelapi.response.skyblock.member.mining.GlaciteTunnels;
import dev.sbs.hypixelapi.response.skyblock.member.mining.HeartOfTheMountain;
import dev.sbs.hypixelapi.response.skyblock.member.pet.Pets;
import dev.sbs.hypixelapi.response.skyblock.member.rift.Rift;
import dev.sbs.hypixelapi.response.skyblock.member.skill.Skills;
import dev.sbs.hypixelapi.response.skyblock.member.slayer.Slayers;
